// Consolidated properties management module
// This file provides named exports expected by `resources/js/app.js`:
// `initProperties`, `filterProperties`, `openViewPropertyModal`,
// `openEditPropertyModal`, `closeViewPropertyModal`, `closeEditPropertyModal`.

// Filter property cards by search input / status
...
// Helper: ensure we only call response.json() for actual JSON responses
...
// Initialize property-related UI (modal hooks, search, filters)
...
// View property modal (renamed to the expected exported name)
async function openViewPropertyModal(propertyId) {
    try {
        ...
        const modalContent = `
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <div class="p-6">
                    <div class="mb-6">
                        <img src="/storage/${property.property_image}" alt="${
            property.property_name
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-gray-50 rounded-lg p-4">
                                ...
                                <div class="text-lg font-semibold text-gray-900">₱${parseFloat(
...
async function loadSmartDevices(propertyId) {
    try {
        ...
        const devices = await parseJsonOrThrow(response);
...
// Edit property modal (renamed to expected exported name)
